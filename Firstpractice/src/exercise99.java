...
public class exercise99 {
    public static void main(String[] args) {
        ...
        System.out.println(logsLocalTime);
        int countTimeBetween7and8 = 0, countTimeBetween8and9=0, countTimeBetween9and10=0, countTimeBetween10and11=0;
        for (LocalTime log : logsLocalTime){
          if (log.getHour()==7){
              countTimeBetween7and8++;
          }else if(log.getHour()==8){
              countTimeBetween8and9++;
          }else if(log.getHour()==9){
              countTimeBetween9and10++;
          }else if (log.getHour()==10){
              countTimeBetween10and11++;
          }
        }
        System.out.println((double) countTimeBetween7and8 / logsLocalTime.size() * 100);
        System.out.println((double) countTimeBetween8and9 / logsLocalTime.size() * 100);
        System.out.println((double) countTimeBetween9and10 / logsLocalTime.size() * 100);
        System.out.println((double) countTimeBetween10and11 / logsLocalTime.size() * 100);
    }
}
